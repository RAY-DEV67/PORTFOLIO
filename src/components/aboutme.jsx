...
export function AboutMe() {
  ...
  const { ref: profileRef5, inView: profileIsVisible5 } = useInView();
    ...
    <p ref={profileRef2} className={profileIsVisible2 ? "aboutme showhead" : "head aboutme"}> With several years of experience in the industry, I have a passion for creating visually stunning and user-friendly websites and applications. My expertise lies in HTML, CSS, and JavaScript, and I am proficient in a variety of frontend frameworks such as React.</p>
